<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme position-fixed h-100 top-0 left-0">
    <div class="app-brand demo">
        <a href="{{ route('vendor-products.index') }}" class="app-brand-link">
    ...
    <ul class="menu-inner py-1">
        <li class="menu-item  open">
            <ul class="menu-sub">
                <li class="menu-item {{ Request::is('vendor-products*') ? 'active' : '' }}">
                    <a href="{{ route('vendor-products.index') }}"
                       class="menu-link {{ Request::is('vendor-products*') ? 'active' : '' }}">
                        <div data-i18n="Without menu"><span class="me-2"><i class='bx bxl-product-hunt'></i></span>Products
                        </div>
                    </a>
                </li>
                <li class="menu-item {{ Request::is('vendor-stocks*') ? 'active' : '' }}">
                    <a href="{{route('vendor-stocks.index')}}"
                       class="menu-link {{ Request::is('vendor-stocks*') ? 'active' : '' }}">
