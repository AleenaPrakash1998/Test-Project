...
@section('content')
    <div class="card mb-4">
        <div class="card-body">
            <h1 class="mb-0 fw-semibold fs-5">Set your new vendor</h1>
    ...
    <form id="vendor-store-form" method="POST" action="{{ route('vendors.store') }}" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" id="email"
                                   aria-describedby="defaultFormControlHelp" name="email" value="{{ old('email') }}">
                            @error('email')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
            ...
            <div class="card-body">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="col-auto me-3">
                        <button type="submit" class="btn btn-primary" id="submit-form">Create Vendor
                        </button>
                    </div>
                    <div class="col-auto">
    ...
    @include('pages.vendors._columns.modal.success-modal')
@endsection
